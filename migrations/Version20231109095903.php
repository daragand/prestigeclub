 ...
 */
final class Version20231109095903 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cart (id INT AUTO_INCREMENT NOT NULL, forfait_id INT DEFAULT NULL, amount DOUBLE PRECISION NOT NULL, INDEX IDX_BA388B7906D5F2C (forfait_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE club_licencie (club_id INT NOT NULL, licencie_id INT NOT NULL, INDEX IDX_38CEFCBB61190A32 (club_id), INDEX IDX_38CEFCBBB56DCD74 (licencie_id), PRIMARY KEY(club_id, licencie_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE licencie (id INT AUTO_INCREMENT NOT NULL, firstname VARCHAR(50) NOT NULL, lastname VARCHAR(50) NOT NULL, birthdate DATE DEFAULT NULL, slug VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, cart_id INT NOT NULL, order_status_id INT NOT NULL, amount DOUBLE PRECISION NOT NULL, payment_date DATE NOT NULL, INDEX IDX_F52993981AD5CDBF (cart_id), INDEX IDX_F5299398D7707B45 (order_status_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE photo_group (id INT AUTO_INCREMENT NOT NULL, group_id_id INT NOT NULL, club_id INT NOT NULL, path VARCHAR(255) NOT NULL, INDEX IDX_D79143722F68B530 (group_id_id), INDEX IDX_D791437261190A32 (club_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, address_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D649F5B7AF75 (address_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE club_licencie ADD CONSTRAINT FK_38CEFCBB61190A32 FOREIGN KEY (club_id) REFERENCES club (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE club_licencie ADD CONSTRAINT FK_38CEFCBBB56DCD74 FOREIGN KEY (licencie_id) REFERENCES licencie (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE club_licencie DROP FOREIGN KEY FK_38CEFCBB61190A32');
        $this->addSql('ALTER TABLE club_licencie DROP FOREIGN KEY FK_38CEFCBBB56DCD74');
        ...
        $this->addSql('DROP TABLE club_licencie');
