 ...
 */
final class Version20240109104945 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE licencie (id INT AUTO_INCREMENT NOT NULL, club_id INT NOT NULL, groupes_id INT DEFAULT NULL, firstname VARCHAR(50) NOT NULL, lastname VARCHAR(50) NOT NULL, birthdate DATE DEFAULT NULL, slug VARCHAR(255) DEFAULT NULL, email VARCHAR(255) NOT NULL, updated_at DATE NOT NULL, INDEX IDX_3B75561261190A32 (club_id), INDEX IDX_3B755612305371B (groupes_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE option_list (id INT AUTO_INCREMENT NOT NULL, photos_id INT DEFAULT NULL, options_id INT NOT NULL, cart_id INT DEFAULT NULL, orders_id INT DEFAULT NULL, quantity INT NOT NULL, is_archived TINYINT(1) NOT NULL, INDEX IDX_ACC652FB301EC62 (photos_id), INDEX IDX_ACC652FB3ADB05F1 (options_id), INDEX IDX_ACC652FB1AD5CDBF (cart_id), INDEX IDX_ACC652FBCFFE9AD6 (orders_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
