 ...
 */
final class Version20240109085037 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cart (id INT AUTO_INCREMENT NOT NULL, forfait_id INT DEFAULT NULL, users_id INT DEFAULT NULL, licencie_id INT DEFAULT NULL, amount DOUBLE PRECISION DEFAULT NULL, uuid_cart VARCHAR(255) NOT NULL, INDEX IDX_BA388B7906D5F2C (forfait_id), UNIQUE INDEX UNIQ_BA388B767B3B43D (users_id), INDEX IDX_BA388B7B56DCD74 (licencie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE club (id INT AUTO_INCREMENT NOT NULL, address_id INT DEFAULT NULL, sport_id INT DEFAULT NULL, name VARCHAR(70) NOT NULL, logo VARCHAR(255) DEFAULT NULL, INDEX IDX_B8EE3872F5B7AF75 (address_id), INDEX IDX_B8EE3872AC78BCF8 (sport_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE licencie (id INT AUTO_INCREMENT NOT NULL, club_id INT NOT NULL, groupes_id INT DEFAULT NULL, firstname VARCHAR(50) NOT NULL, lastname VARCHAR(50) NOT NULL, birthdate DATE DEFAULT NULL, slug VARCHAR(255) DEFAULT NULL, email VARCHAR(255) NOT NULL, updated_at VARCHAR(255) NOT NULL, INDEX IDX_3B75561261190A32 (club_id), INDEX IDX_3B755612305371B (groupes_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE option_list (id INT AUTO_INCREMENT NOT NULL, photos_id INT NOT NULL, options_id INT NOT NULL, cart_id INT DEFAULT NULL, orders_id INT DEFAULT NULL, quantity INT NOT NULL, is_archived TINYINT(1) NOT NULL, INDEX IDX_ACC652FB301EC62 (photos_id), INDEX IDX_ACC652FB3ADB05F1 (options_id), INDEX IDX_ACC652FB1AD5CDBF (cart_id), INDEX IDX_ACC652FBCFFE9AD6 (orders_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, order_status_id INT NOT NULL, users_id INT NOT NULL, forfait_id INT DEFAULT NULL, licencie_id INT DEFAULT NULL, amount DOUBLE PRECISION NOT NULL, payment_date DATE NOT NULL, uuid_order VARCHAR(255) NOT NULL, zip_file VARCHAR(255) DEFAULT NULL, INDEX IDX_F5299398D7707B45 (order_status_id), INDEX IDX_F529939867B3B43D (users_id), INDEX IDX_F5299398906D5F2C (forfait_id), INDEX IDX_F5299398B56DCD74 (licencie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, address_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, firstname VARCHAR(50) NOT NULL, lastname VARCHAR(50) NOT NULL, uuid_user VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D649F5B7AF75 (address_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
